...
const DishCard = ({ item }: DishCardProps) => {
  ...
  // Convert the MenuItem to the format expected by DishDetailModal
  const dish = {
    id: item.id,
    name: item.name,
  ...
  return (
    ...
    >
      ...
      <CardContent className="p-6 flex flex-col flex-grow">
        <h3 className="font-playfair font-bold text-xl tracking-tight text-tamtam-black">{item.name}</h3>
